    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white flex flex-col items-center justify-center text-center relative px-6 py-12 transition-colors duration-500">
      ...
      {animationData && (
        <Lottie
          ...
          loop={false}
          className="h-60 w-60 mb-6"
        />
      )}

      <h1 className="text-3xl font-bold">Opps! Something went wrong.</h1>
      <p className="text-lg mt-2">Please try again or contact us directly..</p>

      {/* ✅ Back to Home Button */}
      <button
        onClick={() => (window.location.href = "/")}
        className="mt-6 px-6 py-2 bg-[#66b5b5] hover:bg-[#66b5b5] text-white font-semibold rounded-md shadow-sm transition duration-200"
      >
        Back to Home
      </button>
    </div>
